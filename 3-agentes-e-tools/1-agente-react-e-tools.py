...
def calculator(expression: str) -> str:
  """Evaluate a simple mathmatical expression and return the result"""
  try:
...
def web_search_mock(query: str) -> str:
  ...
  for county, capital in data.items():
    if county.lower() in query.lower():
      return f"The capital of {county} is {capital}."
  return "I don'r know the capital of that country."
