...
preapre = RunnableLambda(prepare_inputs)
chain = preapre | prompt | llm
...
config = {"configurable": {"session_id": "teste-exemplo"}}

response1 = conversational_chain.invoke({"input": "My name is Hamilton. Reply with 'OK' and do not mention my name"}, config=config)
